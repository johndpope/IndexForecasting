function [ returns ] = ...
    momentum( sect_daily_ret, start, offset, holding_period,lookback,total_days)
...
[ ~ ,sortIndex] = sort(overall,'descend');
returns = sect_daily_ret(CURRENT_PERIOD,sortIndex(1:NO_OF_TOP_SECTORS));
