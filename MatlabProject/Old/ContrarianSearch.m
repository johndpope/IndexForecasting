function [ port_rets ] = ContrarianSearch(all_ret, day_start, day_end, ... 
...
cont_port      =  @(offset)...
    (contrarian(sect_ret,start,offset,holding,lookback,total_days)); 
...
% All indicies: to optimise over - sp500, bonds, gsci, ftse, contrarian
